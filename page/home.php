							...
							<div class="col-md-3">
								<div class="product-item">
									<figure class="product-style">
										<img src="book-images/lautbercerita.png" alt="Books" class="product-item">
										<button type="button" class="add-to-cart" data-product-tile="add-to-cart">Add to
											Cart</button>
									</figure>
									<figcaption>
										<h3>Laut Bercerita</h3>
										<span>Laila S. Chudori</span>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<figure class="products-thumb">
								<img src="book-images/lautbercerita.png" alt="book" class="single-image">
							</figure>
						</div>

						<div class="col-md-6">
							<div class="product-entry">
								<h2 class="section-title divider">August Best Selling Book</h2>

								<div class="products-content">
									<div class="author-name">By Laila S. Chudori</div>
									<h3 class="item-title">Laut Bercerita</h3>
